...
plot input_file every ::1 using 2:xtic(1) title "Baseline", \
     ...
     '' every ::1 using 0:2:(sprintf("%.3f", column(2))) with labels font "Arial,14" offset -1.0,1.8 rotate by 90 tc rgb "#B030B0" notitle, \
     '' every ::1 using 0:3:(sprintf("%.3f", column(3))) with labels font "Arial,14" offset 1.0,1.8 rotate by 90 tc rgb "#30D5C8" notitle
