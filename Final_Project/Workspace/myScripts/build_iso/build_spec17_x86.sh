...
cp $BASE/myScripts/build_iso/configs_cpu17/gcc-linux-x86_ghostMinion.cfg SPEC17_workloads/config

cd SPEC17_workloads

source shrc

runcpu --config=gcc-linux-x86_ghostMinion.cfg --action=build perlbench_s gcc_s mcf_s omnetpp_s xalancbmk_s x264_s deepsjeng_s leela_s exchange2_s xz_s bwaves_s cactuBSSN_s lbm_s wrf_s cam4_s pop2_s imagick_s nab_s fotonik3d_s roms_s -I
runcpu --config=gcc-linux-x86_ghostMinion.cfg --action=run --fake perlbench_s gcc_s mcf_s omnetpp_s xalancbmk_s x264_s deepsjeng_s leela_s exchange2_s xz_s bwaves_s cactuBSSN_s lbm_s wrf_s cam4_s pop2_s imagick_s nab_s fotonik3d_s roms_s --iterations=1 -I
