...
# Usage:
#   ./vars.sh [max_insts] [warmup_insts] (optional:gen5_src_dir) (optional:flavour)
# Example:
#   ./vars.sh 5000000 2000000
max_insts_arg=${1:-10000000000}
warmup_insts_arg=${2:-10000000000}
gem5_src_dir_arg=${3:-"gem5-mirage-v24.0"}
gem5_flavour_arg=${4:-"vanilla"}
...
export GEM5_SRC_DIR="$gem5_src_dir_arg" # onnly dir name not full path
export GEM5_ARCH="ARM" # | "X86"
export GEM5_FLAVOUR="$gem5_flavour_arg" # vanilla | ghost | mirage | create_ckpt
...
export SESSION="$(date +%y%m%d-%H_%M_%S)$(date +%3N)"
...
export BENCHMARK_SUCCESS_FILE="/tmp/success_$SESSION.txt"
export BENCHMARK_FAILED_FILE="/tmp/failed_$SESSION.txt"
...
echo_blue "CHECKPOINT_ROOT           = $CHECKPOINT_ROOT"
